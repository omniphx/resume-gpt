...
At Patterns, I lead the frontend development of a data application builder offering a user-friendly interface similar to Figma. This tool featured configurable nodes, each with a dedicated code editor for languages like Python and SQL. This low code approach dramatically improved the user's ability to debug and prototype data apps rapidly. Leveraging Next.js, I build the core application, while developing our marketing site with Docusaurus.
